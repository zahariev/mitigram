...
describe('SearchComponent', () => {
    ...
    it('should clear the search value and emit the search event when the clear button is clicked', () => {
        ...
        fixture.detectChanges();
        const button = fixture.debugElement.nativeElement.querySelector('.search-close');
        button.click();
    ...
    it('should expand the search input when the search button is clicked', () => {
        const button = fixture.debugElement.nativeElement.querySelector('.search-btn');
        button.click();
        fixture.detectChanges();
    ...
    it('should clear the search value and emit the search event when the Escape key is pressed', () => {
        spyOn(component.search, 'emit');
        component.isExpanded = true;
        component.value = 'test';
        fixture.detectChanges();
